...
char efmlog_locale[32];
char efmlog_session[64];
int init_efmlog_locale(void)
{
	get_system_locale(efmlog_locale);
	if(!strcmp(efmlog_locale,"")) strcpy(efmlog_locale,"kr_utf8");

	strcpy(efmlog_session, "NULL");
}
#endif // USE_EFMLOG
