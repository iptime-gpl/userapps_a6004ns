/*
 * $Id: uams_dhx2_passwd.c,v 1.2 2013/02/15 03:10:26 thki81 Exp $
 *
                 ...
                 char *rbuf, size_t *rbuflen)
{
	...
	// UNREGISTERED USER
	    char log_user[64];
	    sprintf(log_user, "%s(%s)", !strcmp(username, "nobody")?(char *)(EFMLOG_TEXT(efmlog_locale, "AFP_GUEST")):username, 
				    efmlog_session);
	    efmlog( efmlog_locale, LOG_EFM, EFMLOG_AFP_USER_UNKNOWN, log_user, getpid(), (char *)(EFMLOG_TEXT(efmlog_locale, "AFP_USER_UNKNOWN")));
