/*
 * $Source: /usr/nascvs/source/cyrus-sasl-2.1.25/mac/kerberos_includes/krb_conf.h,v $
 * $Author: thki81 $
 * $Header: /usr/nascvs/source/cyrus-sasl-2.1.25/mac/kerberos_includes/krb_conf.h,v 1.1.1.1 2012/12/07 02:12:52 thki81 Exp $
 *
