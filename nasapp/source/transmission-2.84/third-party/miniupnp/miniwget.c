/* $Id: miniwget.c,v 1.2 2014/10/30 07:11:32 thki81 Exp $ */
/* Project : miniupnp
...
#ifdef USE_EFM_COMMON
static int getdefaultgateway(struct in_addr *addr)
{
        unsigned long d, g;
        char buf[256];
        int line = 0;
                 ...
                 char * addr, int addrlen, unsigned int scope_id)
{
	...
	*size = 0;
	...
	{
		strcpy(gw_str, inet_ntoa(gw));
		if (strcmp(gw_str, hostname))
			return NULL;
	}
#endif
