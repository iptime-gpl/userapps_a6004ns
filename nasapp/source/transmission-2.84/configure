...
# Generated by GNU Autoconf 2.69 for transmission 2.84.
#
...
$0: http://trac.transmissionbt.com/newticket about your
...
PACKAGE_STRING='transmission 2.84'
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
\`configure' configures transmission 2.84 to adapt to many kinds of systems.
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of transmission 2.84:";;
   esac
  cat <<\_ACEOF
...
It was created by transmission $as_me 2.84, which was
...
USERAGENT_PREFIX=2.84

PEERID_PREFIX=-TR2840-
...
for ac_func in iconv_open pread pwrite lrintf strlcpy daemon dirname basename strcasecmp localtime_r fallocate64 posix_fallocate memmem strsep strtold syslog valloc getpagesize posix_memalign statvfs htonll ntohll mkdtemp
do :
...
if test -n "$PKG_CONFIG"; then
    ...
    { { $as_echo "$as_me:${as_lineno-$LINENO}: \$PKG_CONFIG --exists --print-errors \"openssl >= \$OPENSSL_MINIMUM\""; } >&5
...
$as_echo_n "checking for OpenSSL... " >&6; }
    ...
    if test x_$found_ssl != x_yes; then
        as_fn_error $? "Cannot locate ssl" "$LINENO" 5
    else
...
if test -n "$PKG_CONFIG"; then
    if test -n "$LIBCURL_CFLAGS"; then
        ...
        if test -n "$PKG_CONFIG" && \
    { { $as_echo "$as_me:${as_lineno-$LINENO}: \$PKG_CONFIG --exists --print-errors \"libcurl >= \$CURL_MINIMUM\""; } >&5
...
if $PKG_CONFIG --atleast-pkgconfig-version 0.20; then
        ...
        if test $_pkg_short_errors_supported = yes; then
	        LIBCURL_PKG_ERRORS=`$PKG_CONFIG --short-errors --errors-to-stdout --print-errors "libcurl >= $CURL_MINIMUM"`
        else
	        LIBCURL_PKG_ERRORS=`$PKG_CONFIG --errors-to-stdout --print-errors "libcurl >= $CURL_MINIMUM"`
        fi
	# Put the nasty error message in config.log where it belongs
	echo "$LIBCURL_PKG_ERRORS" >&5

	as_fn_error $? "Package requirements (libcurl >= $CURL_MINIMUM) were not met:
...
if test -n "$PKG_CONFIG"; then
    if test -n "$LIBEVENT_CFLAGS"; then
        ...
        if test -n "$PKG_CONFIG" && \
    { { $as_echo "$as_me:${as_lineno-$LINENO}: \$PKG_CONFIG --exists --print-errors \"libevent >= \$LIBEVENT_MINIMUM\""; } >&5
  ($PKG_CONFIG --exists --print-errors "libevent >= $LIBEVENT_MINIMUM") 2>&5
  ac_status=$?
  $as_echo "$as_me:${as_lineno-$LINENO}: \$? = $ac_status" >&5
  test $ac_status = 0; }; then
  pkg_cv_LIBEVENT_CFLAGS=`$PKG_CONFIG --cflags "libevent >= $LIBEVENT_MINIMUM" 2>/dev/null`
else
  pkg_failed=yes
fi
    fi
...
if test -n "$PKG_CONFIG"; then
  ...
  $as_echo "$as_me:${as_lineno-$LINENO}: \$? = $ac_status" >&5
  test $ac_status = 0; }; then
  pkg_cv_LIBEVENT_LIBS=`$PKG_CONFIG --libs "libevent >= $LIBEVENT_MINIMUM" 2>/dev/null`
else
  pkg_failed=yes
fi
    fi
...
if $PKG_CONFIG --atleast-pkgconfig-version 0.20; then
        ...
        if test $_pkg_short_errors_supported = yes; then
	        LIBEVENT_PKG_ERRORS=`$PKG_CONFIG --short-errors --errors-to-stdout --print-errors "libevent >= $LIBEVENT_MINIMUM"`
        else
	        LIBEVENT_PKG_ERRORS=`$PKG_CONFIG --errors-to-stdout --print-errors "libevent >= $LIBEVENT_MINIMUM"`
        fi
	# Put the nasty error message in config.log where it belongs
	echo "$LIBEVENT_PKG_ERRORS" >&5

	as_fn_error $? "Package requirements (libevent >= $LIBEVENT_MINIMUM) were not met:
...
do :
  ac_fn_c_check_header_compile "$LINENO" "/tmp/dummy1_zlib.h" "ac_cv_header__tmp_dummy1_zlib_h" "#include \"zlib.h\"
"
if test "x$ac_cv_header__tmp_dummy1_zlib_h" = xyes; then :
  cat >>confdefs.h <<_ACEOF
...
do :
  ac_fn_c_check_header_compile "$LINENO" "/tmp/dummy3_zlib.h" "ac_cv_header__tmp_dummy3_zlib_h" "#include \"zlib.h\"
"
if test "x$ac_cv_header__tmp_dummy3_zlib_h" = xyes; then :
  cat >>confdefs.h <<_ACEOF
#define HAVE__TMP_DUMMY3_ZLIB_H 1
_ACEOF
 ac_have_zlibh=yes
else
  ac_have_zlibh=no
...
if test $ac_have_zlib = no; then
	{ $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: cannot find ZLIB library" >&5
$as_echo "$as_me: WARNING: cannot find ZLIB library" >&2;}
fi
if test $ac_have_zlibh = no; then
	{ $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: cannot find ZLIB headers" >&5
...
ac_fn_c_check_decl "$LINENO" "posix_fadvise" "ac_cv_have_decl_posix_fadvise" "
...
if test "${with_inotify+set}" = set; then :
  withval=$with_inotify; want_inotify=${withval}
else
...
if test "${with_kqueue+set}" = set; then :
  withval=$with_kqueue; want_kqueue=${withval}
else
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking µTP" >&5
$as_echo_n "checking µTP... " >&6; }
build_utp="no"
...
# Check whether --enable-utp was given.
if test "${enable_utp+set}" = set; then :
  enableval=$enable_utp; want_utp=${enableval}
else
  want_utp=${have_utp}
fi
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: result: $build_utp" >&5
$as_echo "$build_utp" >&6; }
...
$as_echo "#define MINIUPNPC_API_VERSION 8" >>confdefs.h
...
$as_echo "#define MINIUPNPC_API_VERSION 5" >>confdefs.h
...
LIBS="$ac_save_LIBS"
{ $as_echo "$as_me:${as_lineno-$LINENO}: result: $upnp_version" >&5
$as_echo "$upnp_version" >&6; }
...
if test "x$upnp_version" = "xnone" ; then
    ...
    $as_echo "#define SYSTEM_MINIUPNP 1" >>confdefs.h
...
# Check whether --enable-external-natpmp was given.
if test "${enable_external_natpmp+set}" = set; then :
  enableval=$enable_external_natpmp; want_external_natpmp=${enableval}
else
...
if test "x$want_external_natpmp" != "xno" ; then
 ...
 if test "x$build_bundled_natpmp" = "xyes"; then
  BUILD_NATPMP_TRUE=
  BUILD_NATPMP_FALSE='#'
else
  BUILD_NATPMP_TRUE='#'
...
if test -n "$PKG_CONFIG" && \
    { { $as_echo "$as_me:${as_lineno-$LINENO}: \$PKG_CONFIG --exists --print-errors \"gtk+-3.0 >= \$GTK_MINIMUM
                  glib-2.0 >= \$GLIB_MINIMUM
                  gio-2.0 >= \$GIO_MINIMUM,
                  gmodule-2.0 >= \$GLIB_MINIMUM
                  gthread-2.0 >= \$GLIB_MINIMUM\""; } >&5
  ($PKG_CONFIG --exists --print-errors "gtk+-3.0 >= $GTK_MINIMUM
                  glib-2.0 >= $GLIB_MINIMUM
                  gio-2.0 >= $GIO_MINIMUM,
                  gmodule-2.0 >= $GLIB_MINIMUM
...
if test -n "$PKG_CONFIG"; then
  ...
  $as_echo "$as_me:${as_lineno-$LINENO}: \$? = $ac_status" >&5
  test $ac_status = 0; }; then
  pkg_cv_GTK_CFLAGS=`$PKG_CONFIG --cflags "gtk+-3.0 >= $GTK_MINIMUM
                              glib-2.0 >= $GLIB_MINIMUM
                              gio-2.0 >= $GIO_MINIMUM,
                              gmodule-2.0 >= $GLIB_MINIMUM
                              gthread-2.0 >= $GLIB_MINIMUM" 2>/dev/null`
else
  pkg_failed=yes
fi
    fi
...
if test -n "$PKG_CONFIG"; then
  ...
  $as_echo "$as_me:${as_lineno-$LINENO}: \$? = $ac_status" >&5
  test $ac_status = 0; }; then
  pkg_cv_GTK_LIBS=`$PKG_CONFIG --libs "gtk+-3.0 >= $GTK_MINIMUM
                              glib-2.0 >= $GLIB_MINIMUM
                              gio-2.0 >= $GIO_MINIMUM,
                              gmodule-2.0 >= $GLIB_MINIMUM
                              gthread-2.0 >= $GLIB_MINIMUM" 2>/dev/null`
...
if $PKG_CONFIG --atleast-pkgconfig-version 0.20; then
        ...
        if test $_pkg_short_errors_supported = yes; then
	        GTK_PKG_ERRORS=`$PKG_CONFIG --short-errors --errors-to-stdout --print-errors "gtk+-3.0 >= $GTK_MINIMUM
                              glib-2.0 >= $GLIB_MINIMUM
                              gio-2.0 >= $GIO_MINIMUM,
                              gmodule-2.0 >= $GLIB_MINIMUM
                              gthread-2.0 >= $GLIB_MINIMUM"`
        else
	        GTK_PKG_ERRORS=`$PKG_CONFIG --errors-to-stdout --print-errors "gtk+-3.0 >= $GTK_MINIMUM
                              glib-2.0 >= $GLIB_MINIMUM
                              gio-2.0 >= $GIO_MINIMUM,
                              gmodule-2.0 >= $GLIB_MINIMUM
                              gthread-2.0 >= $GLIB_MINIMUM"`
	...
	as_fn_error $? "Package requirements (gtk+-3.0 >= $GTK_MINIMUM
                              glib-2.0 >= $GLIB_MINIMUM
                              gio-2.0 >= $GIO_MINIMUM,
                              gmodule-2.0 >= $GLIB_MINIMUM
                              gthread-2.0 >= $GLIB_MINIMUM) were not met:
...
pkg_failed=no
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for LIBAPPINDICATOR" >&5
$as_echo_n "checking for LIBAPPINDICATOR... " >&6; }

if test -n "$PKG_CONFIG"; then
    if test -n "$LIBAPPINDICATOR_CFLAGS"; then
        pkg_cv_LIBAPPINDICATOR_CFLAGS="$LIBAPPINDICATOR_CFLAGS"
    else
        if test -n "$PKG_CONFIG" && \
    { { $as_echo "$as_me:${as_lineno-$LINENO}: \$PKG_CONFIG --exists --print-errors \"appindicator3-0.1 >= \$LIBAPPINDICATOR_MINIMUM\""; } >&5
  ($PKG_CONFIG --exists --print-errors "appindicator3-0.1 >= $LIBAPPINDICATOR_MINIMUM") 2>&5
  ac_status=$?
  $as_echo "$as_me:${as_lineno-$LINENO}: \$? = $ac_status" >&5
  test $ac_status = 0; }; then
  pkg_cv_LIBAPPINDICATOR_CFLAGS=`$PKG_CONFIG --cflags "appindicator3-0.1 >= $LIBAPPINDICATOR_MINIMUM" 2>/dev/null`
else
  pkg_failed=yes
fi
    fi
...
if test -n "$PKG_CONFIG"; then
    if test -n "$LIBAPPINDICATOR_LIBS"; then
        pkg_cv_LIBAPPINDICATOR_LIBS="$LIBAPPINDICATOR_LIBS"
    else
        if test -n "$PKG_CONFIG" && \
    { { $as_echo "$as_me:${as_lineno-$LINENO}: \$PKG_CONFIG --exists --print-errors \"appindicator3-0.1 >= \$LIBAPPINDICATOR_MINIMUM\""; } >&5
  ($PKG_CONFIG --exists --print-errors "appindicator3-0.1 >= $LIBAPPINDICATOR_MINIMUM") 2>&5
  ...
  $as_echo "$as_me:${as_lineno-$LINENO}: \$? = $ac_status" >&5
  test $ac_status = 0; }; then
  pkg_cv_LIBAPPINDICATOR_LIBS=`$PKG_CONFIG --libs "appindicator3-0.1 >= $LIBAPPINDICATOR_MINIMUM" 2>/dev/null`
else
  pkg_failed=yes
fi
    fi
...
if $PKG_CONFIG --atleast-pkgconfig-version 0.20; then
        ...
        if test $_pkg_short_errors_supported = yes; then
	        LIBAPPINDICATOR_PKG_ERRORS=`$PKG_CONFIG --short-errors --errors-to-stdout --print-errors "appindicator3-0.1 >= $LIBAPPINDICATOR_MINIMUM"`
        else
	        LIBAPPINDICATOR_PKG_ERRORS=`$PKG_CONFIG --errors-to-stdout --print-errors "appindicator3-0.1 >= $LIBAPPINDICATOR_MINIMUM"`
        fi
	# Put the nasty error message in config.log where it belongs
	echo "$LIBAPPINDICATOR_PKG_ERRORS" >&5
...
$as_echo "no" >&6; }
	...
	LIBAPPINDICATOR_CFLAGS=$pkg_cv_LIBAPPINDICATOR_CFLAGS
	LIBAPPINDICATOR_LIBS=$pkg_cv_LIBAPPINDICATOR_LIBS
        { $as_echo "$as_me:${as_lineno-$LINENO}: result: yes" >&5
$as_echo "yes" >&6; }
    ...
    if test "x$have_libappindicator" = "xyes"; then
        ...
        $as_echo "#define HAVE_LIBAPPINDICATOR 1" >>confdefs.h
...
# Check whether --enable-lightweight was given.
if test "${enable_lightweight+set}" = set; then :
  enableval=$enable_lightweight; enable_lightweight=${enableval}
else
...
$as_echo "#define TR_LIGHTWEIGHT 1" >>confdefs.h
...
if test "${enable_daemon+set}" = set; then :
 ...
 if test "x$build_daemon" = "xyes"; then
  BUILD_DAEMON_TRUE=
  BUILD_DAEMON_FALSE='#'
else
  BUILD_DAEMON_TRUE='#'
...
if test "x$build_mac" = "xyes" ; then
   $as_echo "#define BUILD_MAC_CLIENT 1" >>confdefs.h
...
if test "x$have_darwin" = "xyes"; then
    ...
    $as_echo "#define SYS_DARWIN 1" >>confdefs.h

fi
if test "x$have_msw" = "xyes"; then
    $as_echo "#define HAVE_MSW 1" >>confdefs.h
...
if test -z "${TR_UNSTABLE_TRUE}" && test -z "${TR_UNSTABLE_FALSE}"; then
  as_fn_error $? "conditional \"TR_UNSTABLE\" was never defined.
Usually this means the macro was only invoked conditionally." "$LINENO" 5
fi
if test -z "${am__fastdepCC_TRUE}" && test -z "${am__fastdepCC_FALSE}"; then
  as_fn_error $? "conditional \"am__fastdepCC\" was never defined.
...
if test -z "${BUILD_UTP_TRUE}" && test -z "${BUILD_UTP_FALSE}"; then
  as_fn_error $? "conditional \"BUILD_UTP\" was never defined.
Usually this means the macro was only invoked conditionally." "$LINENO" 5
fi
if test -z "${BUILD_MINIUPNP_TRUE}" && test -z "${BUILD_MINIUPNP_FALSE}"; then
  as_fn_error $? "conditional \"BUILD_MINIUPNP\" was never defined.
Usually this means the macro was only invoked conditionally." "$LINENO" 5
fi
if test -z "${BUILD_NATPMP_TRUE}" && test -z "${BUILD_NATPMP_FALSE}"; then
  as_fn_error $? "conditional \"BUILD_NATPMP\" was never defined.
Usually this means the macro was only invoked conditionally." "$LINENO" 5
fi
...
if test -z "${BUILD_MAC_TRUE}" && test -z "${BUILD_MAC_FALSE}"; then
  as_fn_error $? "conditional \"BUILD_MAC\" was never defined.
Usually this means the macro was only invoked conditionally." "$LINENO" 5
fi
if test -z "${BUILD_DAEMON_TRUE}" && test -z "${BUILD_DAEMON_FALSE}"; then
  as_fn_error $? "conditional \"BUILD_DAEMON\" was never defined.
Usually this means the macro was only invoked conditionally." "$LINENO" 5
fi
...
ac_log="
This file was extended by transmission $as_me 2.84, which was
generated by GNU Autoconf 2.69.  Invocation command line was
...
ac_cs_version="\\
transmission config.status 2.84
...
do
  case $ac_config_target in
    ...
    "transmission-gtk.spec") CONFIG_FILES="$CONFIG_FILES transmission-gtk.spec" ;;
    ...
    "libtransmission/Makefile") CONFIG_FILES="$CONFIG_FILES libtransmission/Makefile" ;;
    "utils/Makefile") CONFIG_FILES="$CONFIG_FILES utils/Makefile" ;;
    "third-party/Makefile") CONFIG_FILES="$CONFIG_FILES third-party/Makefile" ;;
    "third-party/dht/Makefile") CONFIG_FILES="$CONFIG_FILES third-party/dht/Makefile" ;;
    "third-party/libutp/Makefile") CONFIG_FILES="$CONFIG_FILES third-party/libutp/Makefile" ;;
    ...
    "gtk/icons/Makefile") CONFIG_FILES="$CONFIG_FILES gtk/icons/Makefile" ;;
    "qt/config.pri") CONFIG_FILES="$CONFIG_FILES qt/config.pri" ;;
    "web/Makefile") CONFIG_FILES="$CONFIG_FILES web/Makefile" ;;
    "web/images/Makefile") CONFIG_FILES="$CONFIG_FILES web/images/Makefile" ;;
    "web/style/Makefile") CONFIG_FILES="$CONFIG_FILES web/style/Makefile" ;;
    "web/style/jqueryui/Makefile") CONFIG_FILES="$CONFIG_FILES web/style/jqueryui/Makefile" ;;
    "web/style/jqueryui/images/Makefile") CONFIG_FILES="$CONFIG_FILES web/style/jqueryui/images/Makefile" ;;
    "web/style/transmission/Makefile") CONFIG_FILES="$CONFIG_FILES web/style/transmission/Makefile" ;;
    "web/style/transmission/images/Makefile") CONFIG_FILES="$CONFIG_FILES web/style/transmission/images/Makefile" ;;
    "web/style/transmission/images/buttons/Makefile") CONFIG_FILES="$CONFIG_FILES web/style/transmission/images/buttons/Makefile" ;;
    "web/javascript/Makefile") CONFIG_FILES="$CONFIG_FILES web/javascript/Makefile" ;;
    "web/javascript/jquery/Makefile") CONFIG_FILES="$CONFIG_FILES web/javascript/jquery/Makefile" ;;
