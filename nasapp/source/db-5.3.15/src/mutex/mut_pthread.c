 ...
 *
 * $Id: mut_pthread.c,v 1.2 2016/09/06 02:40:14 bcmac Exp $
 */
...
#ifdef EFM_ROUTER_PATCH
/* This patch is by bcmac tree.
 * 	pthread_mutexattr_setpshared(&mutexattr, PTHREAD_PROCESS_SHARED) --> not support by uClibc-0.9.32.1.so 
 * */
