static char rcsid[]="$Id: redblack.c,v 1.1.1.1 2011/09/28 09:02:59 mvnas Exp $";
...
/*
 * $Log: redblack.c,v $
 * Revision 1.1.1.1  2011/09/28 09:02:59  mvnas
 *
 *
 * Revision 1.1.1.1  2010/06/01 02:16:46  nas
 * init
 *
